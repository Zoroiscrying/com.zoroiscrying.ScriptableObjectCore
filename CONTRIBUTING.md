...
1. Make an [Issue](https://github.com/zoroiscrying/com.zoroiscrying.ScriptableObjectCore/issues/new)
...
```json
    {
        "dependencies": {
            "com.zoroiscrying.com.zoroiscrying.ScriptableObjectCore": "https://github.com/YOUR_USER/com.zoroiscrying.ScriptableObjectCore.git"
        }
    }
```
